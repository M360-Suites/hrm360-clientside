				...
				<div className="max-w-7xl mx-auto px-6">
					<div className="text-center max-w-3xl mx-auto mb-16">
						...
						<h2 className="text-4xl font-extrabold text-gray-900 mb-6">
							Built for Scale.<br/>
							<span className="text-[#4A1D96]">Designed for Simplicity.</span>
						</h2>
					...
					<div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
						{coreFeatures.map((feat, idx) => (
							<motion.div 
								...
								className="p-6 rounded-2xl bg-white border border-gray-200 shadow-sm hover:border-[#4A1D96] transition-colors"
							>
								<div className="w-12 h-12 rounded-xl bg-[#4A1D96]/10 text-[#4A1D96] flex items-center justify-center mb-6">
				...
				<div className="max-w-7xl mx-auto px-6">
					<div className="text-center max-w-3xl mx-auto mb-16">
						...
						<h2 className="text-4xl font-extrabold text-gray-900 mb-6 leading-tight">
							...
							<span className="text-[#4A1D96]">Will Ever Need</span>
						</h2>
						...
						{modules.map((mod, idx) => (
							...
							>
								<div className="flex items-center gap-3 mb-4">
									<div className={`w-10 h-10 rounded-lg flex items-center justify-center bg-[#4A1D96]/10 text-[#4A1D96]`}>
