			...
			<div className="max-w-7xl mx-auto px-6 relative z-10 w-full">
				...
				>
					<div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white border border-gray-200 shadow-sm">
						<span className="bg-[#4A1D96] text-white text-[10px] font-bold px-2 py-0.5 rounded-full tracking-wider">NEW</span>
						<span className="text-sm font-medium text-gray-700 pr-2">Introducing AI-Powered HR Analytics</span>
						<ChevronRight className="w-4 h-4 text-[#4A1D96]" />
					</div>
				</motion.div>
				...
				>
					The Smartest Way <br />
					<span className="text-[#4A1D96]">to Manage Your</span> <br />
					Entire Workforce
				</motion.h1>
				...
				>
					<Link to="/register" className="w-full sm:w-auto flex items-center justify-center gap-2 bg-[#4A1D96] hover:bg-[#3000b3] text-white px-8 py-4 rounded-xl font-semibold text-lg transition-all shadow-md hover:-translate-y-0.5">
					...
					<button className="w-full sm:w-auto flex items-center justify-center gap-3 bg-white hover:bg-gray-50 text-gray-900 border border-gray-200 px-8 py-4 rounded-xl font-semibold text-lg transition-all hover:-translate-y-0.5 shadow-sm">
						<div className="w-8 h-8 rounded-full bg-blue-50 flex items-center justify-center">
							<Play className="w-4 h-4 text-[#4A1D96] fill-[#4A1D96] ml-1" />
						</div>
						Watch Demo
					</button>
				</motion.div>
				...
				>
					...
					<div className="absolute top-[20%] -right-8 z-20 bg-white rounded-full px-4 py-2 shadow-lg border border-gray-100 flex items-center gap-2 animate-bounce" style={{animationDuration: '3s'}}>
						<div className="w-2 h-2 rounded-full bg-[#4A1D96] animate-pulse"></div>
						<span className="text-[#4A1D96] font-semibold text-sm">Live</span>
					...
					<div className="bg-white rounded-2xl shadow-2xl border border-gray-200 overflow-hidden">
						...
						<div className="flex h-[400px]">
							...
							<div className="w-56 border-r border-gray-100 p-4 flex flex-col gap-2">
								...
								<div className="px-3 py-2 rounded-lg bg-[#4A1D96]/10 text-[#4A1D96] font-medium text-sm">Dashboard</div>
							...
							<div className="flex-1 bg-slate-50 p-6 flex flex-col gap-6 overflow-hidden">
								<div className="flex justify-between items-center">
									...
									<button className="bg-[#4A1D96] text-white px-4 py-2 rounded-full text-sm font-medium">
										+ Add Employee
									</button>
								</div>
								...
								<div className="grid grid-cols-3 gap-4">
									<div className="bg-white p-4 rounded-xl border border-gray-100 shadow-sm">
										...
										<p className="text-xs text-[#4A1D96] font-medium mt-1">+12%</p>
									</div>
									<div className="bg-white p-4 rounded-xl border border-gray-100 shadow-sm">
										<p className="text-xs text-gray-500 mb-2">Present Today</p>
										<p className="text-2xl font-bold text-gray-900">1,089</p>
										<p className="text-xs text-[#4A1D96] font-medium mt-1">87.3%</p>
									</div>
									<div className="bg-white p-4 rounded-xl border border-gray-100 shadow-sm">
								...
								<div className="bg-white p-5 rounded-xl border border-gray-100 shadow-sm flex-1 flex flex-col">
									...
									<div className="flex-1 flex items-end gap-2">
										{[40, 50, 45, 60, 55, 48, 65, 58, 42, 62, 50, 45, 55, 75].map((height, i) => (
											<div key={i} className={`flex-1 rounded-t-sm ${i === 13 ? 'bg-[#4A1D96]' : 'bg-[#4A1D96]/20'}`} style={{ height: `${height}%` }}></div>
										))}
									</div>
								</div>
							</div>
			...
			<div className="max-w-5xl mx-auto w-full px-6 mt-24 z-10">
				<div className="grid grid-cols-2 md:grid-cols-4 gap-px bg-gray-200 border border-gray-200 rounded-2xl overflow-hidden">
					<div className="bg-white p-8 text-center">
						<div className="text-3xl md:text-4xl font-extrabold text-[#4A1D96] mb-1">10,000+</div>
						<div className="text-sm text-gray-600 font-medium">Active Employees Managed</div>
					</div>
					<div className="bg-white p-8 text-center">
						<div className="text-3xl md:text-4xl font-extrabold text-[#4A1D96] mb-1">98%</div>
						<div className="text-sm text-gray-600 font-medium">Uptime Guarantee</div>
					</div>
					<div className="bg-white p-8 text-center">
						<div className="text-3xl md:text-4xl font-extrabold text-[#4A1D96] mb-1">60%</div>
						<div className="text-sm text-gray-600 font-medium">HR Time Saved</div>
					</div>
					<div className="bg-white p-8 text-center">
						<div className="text-3xl md:text-4xl font-extrabold text-[#4A1D96] mb-1">150+</div>
