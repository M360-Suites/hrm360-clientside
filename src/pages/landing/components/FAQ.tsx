			...
			<div className="max-w-4xl mx-auto px-6">
				<div className="text-center max-w-3xl mx-auto mb-16">
					...
					<h2 className="text-4xl font-extrabold text-gray-900 mb-6 leading-tight">
						Frequently Asked<br/>
						<span className="text-[#4A1D96]">Questions</span>
					</h2>
					<p className="text-lg text-gray-600">
						Everything you need to know about HRM360. Can't find the answer? <a href="#" className="text-[#4A1D96] font-medium hover:underline">Chat with us</a>
					</p>
				</div>
				...
				<div className="space-y-4">
					{faqs.map((q, idx) => (
						<motion.div 
							...
							className="border border-gray-200 rounded-xl p-6 flex justify-between items-center cursor-pointer hover:border-[#4A1D96] transition-colors bg-slate-50"
						>
