      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 pt-4">
        <div className="lg:col-span-2 space-y-4">
          {promotions.map((promo, idx) => (
            <div key={idx} className="bg-white p-5 rounded-2xl border border-gray-100 shadow-xs hover:shadow-md transition-shadow cursor-pointer">
              <div className="flex items-start justify-between">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-xs p-8 flex flex-col items-center justify-center text-center h-80 sticky top-6">
