  ...
  return (
    <div className="mx-auto w-full max-w-7xl space-y-6 pb-12">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div><p className="mb-1 text-xs font-semibold uppercase tracking-[0.18em] text-[#3B00D9]">Time away during work hours</p><h2 className="text-2xl font-semibold text-gray-900">Permissions</h2><p className="mt-1 text-sm text-gray-500">{canReview ? "Review employee movement requests and monitor return compliance." : "Request short time away and record when you leave or return."}</p></div>
        {!canReview && <button onClick={() => { clearError(); setShowRequest(true); }} className="inline-flex items-center justify-center gap-2 rounded-xl bg-[#3B00D9] px-5 py-3 text-sm font-semibold text-white"><Plus size={17} />Request permission</button>}
      </div>
