            ...
            <div key={idx} className="p-5 flex items-center justify-between hover:bg-gray-50/50 transition-colors">
              <div>
                ...
                <div className="flex items-center gap-1.5 text-xs text-gray-500">
                  <div className="w-4 h-4 bg-blue-600 rounded flex items-center justify-center text-white font-bold text-[10px]">in</div>
              ...
              <div className="flex items-center gap-6">
                ...
                <button className="bg-[#4D82F3] hover:bg-blue-600 text-white px-5 py-2 rounded-lg text-sm font-medium transition-colors shadow-sm">
                  View
                </button>
              </div>
            </div>
