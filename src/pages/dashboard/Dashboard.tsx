				...
				<div className='bg-white p-5 rounded-2xl border border-gray-100 shadow-sm'>
					...
					<div className='flex items-center gap-4 text-xs text-gray-500'>
						<div className='flex items-center gap-1.5'>
							...
							On leave - {todayStats?.onLeave || 0}
						</div>
						<div className='flex items-center gap-1.5'>
							<div className='w-2.5 h-2.5 rounded-full bg-blue-500'></div>{" "}
							Sign in - {todayStats?.present || 0}
						</div>
					</div>
				</div>
						...
						<div className='h-64 flex items-end justify-between relative pt-8 border-b border-gray-100'>
							<div className='absolute inset-0 top-10 flex items-center justify-center'>
								...
								>
									...
									/>
									<path
										d='M0,25 Q10,10 20,25 T40,25 T60,20 T80,35 T100,20 L100,50 L0,50 Z'
										fill='url(#gradient)'
										stroke='none'
										opacity='0.1'
									/>
							...
							<div className='absolute left-0 top-0 h-full flex flex-col justify-between text-[10px] text-gray-400 pb-6 w-full'>
								<div className='flex items-center w-full border-b border-gray-50 pb-1'>
									<span>200</span>
								</div>
								<div className='flex items-center w-full border-b border-gray-50 pb-1'>
									<span>150</span>
					...
					<div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
						<div className='bg-white p-6 rounded-2xl border border-gray-100 shadow-sm'>
							<div className='flex items-center justify-between mb-4'>
								...
								<button className='text-xs font-medium text-[#3B00D9] bg-indigo-50 px-3 py-1 rounded-full'>
									See all
								</button>
							</div>
						...
						<div className='grid grid-cols-7 gap-1 text-center text-sm font-medium text-gray-700'>
							{Array(31)
								...
								.map((_, i) => (
									<div
										key={i}
										className={`p-1 ${i + 1 === new Date().getDate() ? "bg-[#FF0055] text-white rounded-full" : ""}`}
									>
										{i + 1}
									</div>
								))}
					...
					<div className='bg-white p-5 rounded-2xl border border-gray-100 shadow-sm'>
						...
						<div className='space-y-3 mb-4'>
							<div className='flex gap-3'>
								<div className='mt-1'>
									<div className='w-4 h-4 rounded bg-green-500 flex items-center justify-center text-white'>
								...
								<div>
									...
									<p className='text-xs text-gray-500 mt-0.5'>
										Follow an Interview with Adeleke Jahson
									</p>
